...
const PolarGraph = () => {
    ...
    const onChartLoad = (args: ILoadedEventArgs): void => {
        document.getElementById('chartsPolar1')?.setAttribute('title', '');
    };
    ...
    return (
        <div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='chartsPolar1'style={{ textAlign: "center" }} primaryXAxis={{ valueType: 'Category', labelPlacement: 'OnTicks', interval: 1, coefficient: Browser.isDevice ? 80 : 100 }} load={load.bind(this)} legendSettings= {{ visible: true, enableHighlight: true }} title="Wind Rose Chart" loaded={onChartLoad.bind(this)} tooltip={{ enable: true }}>
