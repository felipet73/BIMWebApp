...
export const foodData = [
    { text: 'Hamburger', id: 'list-01', price: '$10', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/hamburger.jpg', type: 'non-veg', description: 'A patty of ground beef grilled and placed between two halves of a bun with slices of lettuce and mayonnaise', rating: 3 },
    { text: 'Cheeseburger', id: 'list-02', price: '$12', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/cheeseburger.jpg', type: 'veg', description: 'A hamburger with a slice of melted cheese on top of the meat patty, added near the end of the cooking time', rating: 4 },
    { text: 'Sandwich', id: 'list-03', price: '$8', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/sandwich.jpg', type: 'veg', description: 'A combination of vegetables, sliced cheese or meat, placed on or between slices of bread with layer of ingredients', rating: 5 },
    { text: 'Milkshake', id: 'list-04', price: '$6', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/milkshake.jpg', type: 'veg', description: 'A sweet beverage made by blending milk, ice cream, and flavorings or fruit syrup into a thick, sweet, cold mixture', rating: 3 },
    { text: 'Muffin', id: 'list-05', price: '$11', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/muffin.jpg', type: 'veg', description: 'Muffins are single-serving quick breads, which rise with the help of baking soda or baking powder and eggs instead of yeast', rating: 4 },
    { text: 'Pizza', id: 'list-06', price: '$22', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/pizza.jpg', type: 'veg', description: 'A combination of a flattened disk of bread dough with olive oil, oregano, tomato, mozzarella cheese', rating: 3 },
    { text: 'Onion ring', id: 'list-07', price: '$10', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/onionrings.jpg', type: 'veg', description: 'Consists of a cross-sectional "ring" of onion dipped in bread crumbs and then deep fried; variant is made with onion paste.', rating: 4 },
    { text: 'Sausage', id: 'list-08', price: '$15', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/sausage.jpg', type: 'veg', description: 'Sausage is a combination of minced/ground meat, a binder, water and seasonings, mild but strongly spiced', rating: 5 },
    { text: 'Pretzel', id: 'list-09', price: '$25', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/pretzel.jpg', type: 'veg', description: 'Made from a rope of dough, the pretzel is briefly boiled and then glazed with egg, salted, and baked', rating: 3 },
    { text: 'Pancake', id: 'list-10', price: '$23', src: 'https://ej2.syncfusion.com/react/demos/src/listview/images/pancake.jpg', type: 'veg', description: 'A combination of eggs, milk on a hot surface such as a griddle or frying pan, often frying with oil or butter', rating: 4 },
];
//Define an array of JSON data
