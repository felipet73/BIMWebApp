...
import {
  ...
  IGanttData, Resize, Sort, ContextMenu, ColumnsDirective, ColumnDirective, EventMarkersDirective, EventMarkerDirective
...
const GantControl = () => {
  ...
  return (
        <GanttComponent id='ContextMenu' ref={ganttInstance} dataSource={editingData} dateFormat={'MMM dd, y'} enableContextMenu={true}
          ...
          height='100%' editSettings={editSettings} gridLines={gridLines} toolbar={toolbar} resourceFields={resourceFields} resources={editingResources}>
          <ColumnsDirective>
