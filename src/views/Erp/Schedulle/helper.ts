...
//export const applyCategoryColor = applyCategoryColor;
function generateObject(start:any, end:any, isWeekDaysOnly:any) {
...
//export const generateObject = generateObject;
...
//export const getReadOnlyEventsData = getReadOnlyEventsData;
...
//export const getReminderEvents = getReminderEvents;
function generateResourceData(startId:any, endId:any, text:any) {
    var data = [];
    var colors = [
...
//export const generateResourceData = generateResourceData();
