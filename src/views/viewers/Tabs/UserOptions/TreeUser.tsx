...
function add():any {
    let nodeId:any;
    if (diagramInstance.selectedItems.nodes &&  diagramInstance.selectedItems.nodes.length > 0) {
  ...
  function addNode(nodeId:any) {
    ...
    treeObj.addNodes([item], targetNodeId, undefined);
  ...
  return (
    ...
    <div className="control-section row uploadpreview">
      ...
      <div className="content-wrapper" style={{ width: '100%' }}>
        ...
        <div id="diagram-spaceTree" style={{ width: '72%', float: 'right' }}>
          <DiagramComponent
            id="diagramTreeUser"
